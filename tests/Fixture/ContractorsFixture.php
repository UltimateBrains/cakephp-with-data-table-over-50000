...
class ContractorsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'canqualify_date' => ['type' => 'timestamp', 'length' => null, 'default' => null, 'null' => true, 'comment' => null, 'precision' => null],
        ...
        'send_invoice' => ['type' => 'boolean', 'length' => null, 'default' => null, 'null' => true, 'comment' => null, 'precision' => null],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'contractors_fk' => ['type' => 'foreign', 'columns' => ['customer_representative_id'], 'references' => ['customer_representative', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'canqualify_date' => 1571314648,
                'subscription_date' => '2019-10-17',
